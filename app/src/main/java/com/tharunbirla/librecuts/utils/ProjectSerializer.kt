    ...
    private val editOperationSerializer = object : JsonSerializer<EditOperation>, JsonDeserializer<EditOperation> {
        ...
        override fun deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext): EditOperation {
            ...
            if (opTypeStr == null) {
                ...
                val validClasses = setOf("Trim", "SpeedMain", "ReverseMain", "MirrorMain", "Crop", "AddText", "Merge", "MaskMain", "MuteAudio", "Transition", "MuteClip", "ColorFilter", "AddBackgroundAudio", "AddImageOverlay", "AddSubtitles", "Adjust", "CanvasBackground", "TrackObject")
            ...
            val clazz = when (type) {
                ...
                "TrackObject" -> EditOperation.TrackObject::class.java
                else -> null
            }
